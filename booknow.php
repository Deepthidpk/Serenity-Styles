        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Book Now</span></p>
            </div>
    	...
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
		            ...
		            <div class="form-group ml-md-4">
		               <a href="cart.html"><input type="submit" value="Appointment" class="btn btn-white py-3 px-4"></a>
					   <!-- <button onclick="cart.html">Appointment</button> -->
		            </div>
	    				</div>
	    			</form>
	    		</div>
